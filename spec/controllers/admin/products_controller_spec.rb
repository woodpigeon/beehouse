...
describe ProductsController do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_product as @product" do
        # Trigger the behavior that occurs when invalid params are submitted
        Product.any_instance.stub(:save).and_return(false)
        post :create, {:product => { "range_start" => "invalid value" }}, valid_session
        assigns(:product).should be_a_new(Product)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_product" do
        ...
        Product.any_instance.should_receive(:update_attributes).with({ "range_start" => "1" })
        put :update, {:id => product.to_param, :product => { "range_start" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_product as @product" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Product.any_instance.stub(:save).and_return(false)
        put :update, {:id => product.to_param, :product => { "range_start" => "invalid value" }}, valid_session
        assigns(:product).should eq(product)
      end
